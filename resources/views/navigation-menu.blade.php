<nav x-data="{ open: false }" class="bg-gradient-to-r from-indigo-600 to-blue-500 shadow-md">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-6 sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('industri') }}" :active="request()->routeIs('industri')" class="text-white hover:text-indigo-100">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                        </svg>
                        {{ __('Industri') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('guru') }}" :active="request()->routeIs('guru')" class="text-white hover:text-indigo-100">
                    ...
                    <x-nav-link href="{{ route('siswa') }}" :active="request()->routeIs('siswa')" class="text-white hover:text-indigo-100">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-gradient-to-b from-indigo-800 to-indigo-900 shadow-lg transform transition-all duration-300 ease-in-out">
        ...
        <div class="pt-1 pb-3 space-y-1">
            ...
            <x-responsive-nav-link href="{{ route('industri') }}" :active="request()->routeIs('industri')" class="text-white">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                    </svg>
            ...
            <x-responsive-nav-link href="{{ route('siswa') }}" :active="request()->routeIs('siswa')" class="text-white">
                <div class="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                    </svg>
